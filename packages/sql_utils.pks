 ...
 *
 *                RESULT_CACHE does not work in 11.2 for invoker-rights (IR) units (i.e. AUTHID CURRENT_USER). From 12c onwards, both IR and 
 *                definer-rights (DR) units can use the result cache, but for IR units the result cache is user-specific.
